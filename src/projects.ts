const projects = [
  {
    ...
    introHTML:
      '<p class="mb-3"><b>장애인과 기업 사이에서 구인구직 중개를 해주는 웹사이트.</b></p>\
        ...
        <p class="mb-3">저는 이 프로젝트에서 프론트엔드를 맡아 <span class="text-blue-500">장애인과 기업 양측의 홈, 검색, 공고 상세, 북마크, 희망 근무지, 지원 현황 페이지를 개발</span>했으며, <span class="text-blue-500">프론트엔드 전체 소스코드 관리 및 CI/CD 관리</span> 역할을 수행했습니다.</p>\
